...
type SetInputDeinterlaceFieldOrderParams struct {
	...
	InputDeinterlaceFieldOrder string `json:"inputDeinterlaceFieldOrder"`
}
...
*/
func (c *Client) SetInputDeinterlaceFieldOrder(params *SetInputDeinterlaceFieldOrderParams) (*SetInputDeinterlaceFieldOrderResponse, error) {
